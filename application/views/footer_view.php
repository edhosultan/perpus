...
<footer class="main-footer">
  <div id="mycredit"><strong> Copyright &copy; <?php echo date('Y'); ?> E-Katalog Dan Peminjaman Buku Perpustakaan
    </strong> All rights | Page rendered in <strong>{elapsed_time}</strong> seconds. | Repost by <a href='https://ayukcodingbersamaoppaedho.com/' title='ayukcodingbersamaoppaedho.com' target='_blank'>ayukcodingbersamaoppaedho.com</a>
