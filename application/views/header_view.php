...
<head>
  ...
  <title><?php echo $title_web; ?> | E-Katalog Dan Peminjaman Buku Perpustakaan </title>
  <!-- Tell the browser to be responsive to screen width -->

  <link rel="icon" href="assets_style/image/iconnih.png" type="image/gif" sizes="16x16">
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="<?php echo base_url('index.php/dashboard'); ?>" class="logo">
        ...
        <span class="logo-lg">Perpustakaan Seru</span>
      </a>
