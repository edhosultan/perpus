...
<head>
    <title>Cetak PDF Laporan Buku</title>
    <style>
        h3 {
            font-size: 20px;
...
<body>
    ...
    if (!empty($_GET['tahun'])) {
        ...
        $tahun = $_GET['tahun'];
        $query = "SELECT * FROM tbl_buku WHERE year(tgl_masuk)='$tahun'";
    ...
    ?>
    <br>
    <div style="font-size: 18px;text-align:center;"><u>Laporan Data Buku</u>
        <br>
        <br>
    </div>
    ...
    <div style="margin-left: 20px">
        <div style="font-size: 18px">Laporan Data Buku
        </div>
    </div>
</body>
