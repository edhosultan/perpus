...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/Buku-23.jpg'); ?>')no-repeat;background-size:100%;">
  <div class="login-box">
    <br />
    <div class="login-logo">
      <a href="index.php" style="color: yellow;">E-Katalog Dan Peminjaman Buku <br /><b>Perpustakaan</b></a>
    </div>
    ...
    <footer>
      <div class="login-box-body text-center bg-blue">
        <a style="color: yellow;"> Copyright &copy; E-Katalog Dan Peminjan Buku - <?php echo date("Y"); ?>
          <br>
          <center>
            <p>Repost by <a href='https://ayukcodingbersamaoppaedho.com/' title='ayukcodingbersamaoppaedho.com' target='_blank'>ayukcodingbersamaoppaedho.com</a></p>
          </center>
